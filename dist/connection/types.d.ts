...
export declare type EventEmitter = <T = object>(eventName: string, payload: T) => void;
export declare type EventListener = (message: Message) => void;
export interface Connection {
    ...
    onNewDisconnection: (callback: (message: NewDisconnectionMessage) => void) => void;
}
