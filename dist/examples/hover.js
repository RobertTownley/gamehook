...
export function HoverExample() {
    ...
    return (_jsxs(Scene, { children: [positions.map(function (p, i) { return (_jsx(Box, { rotation: { x: 0.0, y: 0.0, z: 0.01 }, position: p, onHoverLeave: function () { return setColor(red); }, onHoverEnter: function () { return setColor(blue); }, material: {
                    type: "standard",
                    color: color,
